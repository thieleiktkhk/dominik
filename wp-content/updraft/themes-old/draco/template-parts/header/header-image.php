...
// Title
  ...
  if(is_archive()) { 
    $title_draco = get_the_archive_title();
    $description = get_the_archive_description();
  }

  if(is_search()) {
    if ( have_posts() ) $title_draco = __( 'Search Results for:', 'draco' ).' ' . get_search_query() ;
    else $title_draco = __( 'Nothing Found', 'draco' );
  }

  if(is_404()) {
    $title_draco = __( 'Oops! That page can&rsquo;t be found', 'draco' );
  }
...
<div class="header">
  ...
  <div class="info">
    <h1><?php echo esc_html($title_draco); ?></h1>
