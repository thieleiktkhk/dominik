			...
			<div class="col-md-8 col-sm-8" id="content-aa">
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div class="metabox">
						...
						<span class="entry-comments"><i class="fa fa-comments" aria-hidden="true"></i><?php comments_number( __('0 Comments','pet-animal-store'), __('0 Comments','pet-animal-store'), __('% Comments','pet-animal-store') ); ?> </span>
					</div><!-- metabox -->
	                ...
	                if ( is_singular( 'attachment' ) ) {
						...
						the_post_navigation( array(
							'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next page', 'pet-animal-store' ) . '</span> ' .
								'<span class="screen-reader-text">' . __( 'Next post:', 'pet-animal-store' ) . '</span> ' .
								'<span class="post-title">%title</span>',
							'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous page', 'pet-animal-store' ) . '</span> ' .
